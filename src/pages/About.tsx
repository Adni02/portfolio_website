  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-16">
            ...
            <div>
              ...
              <div className="card-accent">
                <div className="space-y-2 text-lg">
                  ...
                  <p className="font-medium text-gray-900">{cvData.personalInfo.department}</p>
                  <p className="text-gray-700">{cvData.personalInfo.section}</p>
                  <p className="font-medium text-gray-900 mt-3">{cvData.personalInfo.institution}</p>
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6 italic text-gray-600">
          ...
          <div className="space-y-6">
            ...
            <div className="card sticky top-24">
              <h3 className="text-2xl font-serif font-semibold mb-6 pb-4 border-b border-gray-200">Education</h3>
              ...
              {/* External Links */}
              <h4 className="text-lg font-serif font-semibold mt-10 mb-6 pt-6 border-t border-gray-200">Connect</h4>
              <div className="space-y-3 flex flex-col">
                <a
                  href={cvData.personalInfo.orcid}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2 px-4 py-3 bg-purple-50 text-primary hover:bg-purple-100 rounded-lg font-medium transition-all duration-200"
                >
      ...
      <section className="section-alt section-container">
        <h2 className="text-center mb-16">Collaborative Research Excellence</h2>
