        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card text-center">
              ...
              <div className="text-lg font-semibold text-gray-900 mb-2">Coordinator</div>
              <p className="text-gray-600">IEEE Nanotechnology Council - Women in Nanotechnology</p>
            </div>
            <div className="card text-center">
              <div className="text-4xl font-bold text-primary mb-3">20+</div>
              <div className="text-lg font-semibold text-gray-900 mb-2">Journals</div>
              <p className="text-gray-600">Peer-reviewed Journals as Reviewer</p>
            </div>
            <div className="card text-center">
              <div className="text-4xl font-bold text-primary mb-3">Editor</div>
              <div className="text-lg font-semibold text-gray-900 mb-2">High-Impact</div>
              <p className="text-gray-600">Multiple High-Impact Journals</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card-accent">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Social Media Educator</h3>
